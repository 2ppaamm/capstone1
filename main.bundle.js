        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_28__auth0_angular_jwt__["a" /* JwtModule */].forRoot({
                config: {
                    ...
                    whitelistedDomains: [
                        'localhost:4200', 'localhost', 'devapi.pamelalim.me', 'devapi.pamelalim.me', 'quiz.pamelalim.me', 'api.pamelalim.me', 'math.pamelalim.me', 'quiz.all-gifted.com', 'localhost:8000'
                    ]
                }
            })
        ],
...
var HouseListComponent = (function () {
    function HouseListComponent(dashboardService) {
        this.dashboardService = dashboardService;
        this.selectedEvent = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        this.beURL = "" + __WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].apiURL;
    }
...
var CourseService = (function () {
    ...
    CourseService.prototype.getOpenCourses = function () {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "opencourses")
            .map(function (response) { return response; })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].throw(error.json().error || { message: 'Server Error' }); });
        ;
    };
    CourseService.prototype.addCourse = function (course) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "courses", course)
            .map(function (response) { return response; })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].throw(error.json().error || { message: 'Server Error' }); });
    };
    CourseService.prototype.getCourse = function (id) {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "courses/" + id)
            .map(function (response) { return response['course']; })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].throw(error.json().error || { message: 'Server Error' }); });
    };
    CourseService.prototype.updateCourse = function (course) {
        var apiUrl = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "courses";
    ...
    CourseService.prototype.updateCourseImage = function (courseimage, course_id) {
        var apiUrl = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "courseimage";
...
var DashboardService = (function () {
    ...
    DashboardService.prototype.getHouses = function () {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].apiURL + "enrols/users")
    ...
    DashboardService.prototype.getCourses = function () {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].apiURL + "courses")
            .map(function (response) { return response['courses']; })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_3_rxjs_Observable__["Observable"].throw(error.json().error || { message: 'Server Error' }); });
        ;
    };
    DashboardService.prototype.getLeaders = function () {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].apiURL + "leaders")
            .map(function (response) { return response; })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_3_rxjs_Observable__["Observable"].throw(error.json().error || { message: 'Server Error' }); });
        ;
    };
    DashboardService.prototype.getTeach = function () {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].apiURL + "enrols/teachers")
            .map(function (response) { return response['houses']; })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_3_rxjs_Observable__["Observable"].throw(error.json().error || { message: 'Server Error' }); });
        ;
    };
    DashboardService.prototype.getUser = function () {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].apiURL + "api/protected")
...
var HouseTrackService = (function () {
    ...
    HouseTrackService.prototype.getTracks = function () {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "tracks")
            .map(function (response) { return response; })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].throw(error.json().error || { message: 'Server Error' }); });
        ;
    };
    HouseTrackService.prototype.addTrack = function (track) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "tracks", track)
            .map(function (response) { return response; })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].throw(error.json().error || { message: 'Server Error' }); });
    };
    HouseTrackService.prototype.getTrack = function (id) {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "tracks/" + id)
            .map(function (response) { return response['track']; })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].throw(error.json().error || { message: 'Server Error' }); });
    };
    HouseTrackService.prototype.updateTrack = function (track) {
        var apiUrl = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "tracks";
    ...
    HouseTrackService.prototype.deleteTrack = function (houseid, trackid) {
        var apiUrl = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "houses";
    ...
    HouseTrackService.prototype.createTrack = function () {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "tracks/create")
            .map(function (response) { return response; })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].throw(error.json().error || { message: 'Server Error' }); });
        ;
    };
...
var SkillTrackService = (function () {
    ...
    SkillTrackService.prototype.getSkills = function () {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "skills")
            .map(function (response) { return response; })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].throw(error.json().error || { message: 'Server Error' }); });
        ;
    };
    ...
    SkillTrackService.prototype.getSkill = function (id) {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "skills/" + id)
            .map(function (response) { return response['skill']; })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].throw(error.json().error || { message: 'Server Error' }); });
    };
    SkillTrackService.prototype.updateSkill = function (skill) {
        var apiUrl = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "skills";
    ...
    SkillTrackService.prototype.createSkill = function () {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "skills/create")
            .map(function (response) { return response; })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].throw(error.json().error || { message: 'Server Error' }); });
        ;
    };
...
var SkillService = (function () {
    ...
    SkillService.prototype.addSkill = function (skill) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "skills", skill)
            .map(function (response) { return response; })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].throw(error.json().error || { message: 'Server Error' }); });
    };
...
var UserService = (function () {
    ...
    UserService.prototype.getUsers = function () {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "users")
            .map(function (response) { return response; })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].throw(error.json().error || { message: 'Server Error' }); });
        ;
    };
    UserService.prototype.getUser = function (id) {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "users/" + id)
            .map(function (response) { return response['user']; })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].throw(error.json().error || { message: 'Server Error' }); });
    };
    UserService.prototype.updateUser = function (user) {
        var apiUrl = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].apiURL + "users";
...
var environment = {
    ...
    auth0: {
        clientId: 'eVJv6UFM9GVdukBWiURczRCxmb6iaUYG',
        domain: 'pamelalim.auth0.com',
        callbackURL: 'http://math.pamelalim.me/home'
    }
};
